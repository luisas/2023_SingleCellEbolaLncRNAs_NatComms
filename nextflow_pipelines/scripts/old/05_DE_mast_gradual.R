...
for( celltype in celltypes){
    mast_stateVSbaseline_perCelltype(immune.combined, celltype, c("baseline", "early"),robjectsdir, "MAST_invivo_model_", ebola_genes)
    mast_stateVSbaseline_perCelltype(immune.combined, celltype, c("early", "middle"),robjectsdir, "MAST_invivo_model_", ebola_genes)
    mast_stateVSbaseline_perCelltype(immune.combined, celltype, c("middle", "late"),robjectsdir, "MAST_invivo_model_", ebola_genes)
}
