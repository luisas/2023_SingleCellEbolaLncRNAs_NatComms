...
immune.anchors <- FindIntegrationAnchors(object.list = pbmc, dims = 1:20, anchor.features = all_genes)
...
new_name = paste(file_name_no_extension, "_02_integrated_dimred_all.rds", sep  ="_")
saveRDS(immune.combined, file.path(results_folder,new_name))
print("Completed!")
