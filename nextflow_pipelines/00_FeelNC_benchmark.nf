...
params.known_mrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/homosapiens_trainining_chr/Homo_sapiens.GRCh38.100_known_lncrna_all.fa"
params.known_lncrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/homosapiens_trainining_chr/Homo_sapiens.GRCh38.100_known_proteincoding_all.fa"
...
process feelnc_codpot{
  cpus 16
  storeDir "${params.output_dir}/00_feelNC_benchmark_human_fasta/"
