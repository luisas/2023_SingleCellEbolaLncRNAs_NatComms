...
params.known_mrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/Macaca_mulatta.Mmul_10.100_known_lncrna.gtf"
params.known_lncrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/Macaca_mulatta.Mmul_10.100_known_proteincoding.gtf"
...
process feelnc_codpot{
  ...
  cpus 48
  storeDir "${params.output_dir}/00_feelNC_benchmark_macaque_gtf/"
