...
params.known_mrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/gene_annotations/rheMac10_EBOV-Kikwit_lncrna.gtf"
params.known_lncrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/gene_annotations/rheMac10_EBOV-Kikwit_mrnas.gtf"
...
process feelnc_filter{
  ...
  storeDir "${params.output_dir}/00_feelNC_benchmark_macaque"
