...
params.known_mrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/Homo_sapiens.GRCh38.83_antisense.lincRNA_learning5k.fa"
params.known_lncrna = "${params.output_dir}/01_PreliminaryFiles_rheMac10/Homo_sapiens.GRCh38.83_protein_coding_learning5k.fa"
...
process feelnc_codpot{
  cpus 16
  storeDir "${params.output_dir}/00_feelNC_benchmark_human_fasta_5k/"
