...
ref <- import(file.path("/home/luisas/Desktop/cluster/data/01_bulk_RNA-Seq_lncRNAs_annotation/03_novel_lncRNAs_list/rheMac10_EBOV_and_novel.gtf"))
...
rownames(immune.combined)[grep("poly",rownames(immune.combined))]
