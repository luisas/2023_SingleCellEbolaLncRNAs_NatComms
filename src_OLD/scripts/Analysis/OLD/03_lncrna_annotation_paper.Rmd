...
candidates_lncRNA <- import(file.path(datadir, "02_RNA-Seq_all/05_lncrnaAnnotation_no_l_option/feelnc_gencode_linc/candidate_lncRNA.gtf"))
lncRNAs_out <- import(file.path(datadir, "02_RNA-Seq_all/05_lncrnaAnnotation_no_l_option/feelnc_gencode_linc/feelnc_codpot_out/candidate_lncRNA.gtf.lncRNA.gtf"))

mRNAs_out <- import(file.path(datadir, "02_RNA-Seq_all/05_lncrnaAnnotation_no_l_option/feelnc_gencode_linc/feelnc_codpot_out/candidate_lncRNA.gtf.mRNA.gtf"))
stringtie_gtf <- import(file.path(datadir, "02_RNA-Seq_all/04_stringtie/stringtie_merged_reference_guided.gtf"))
...
# merged_annotated <- import(file.path(datadir, "02_RNA-Seq_all/04b_gffCompare/merged.annotated.gtf"))
# merged_annotated <- import(file.path(datadir, "02_RNA-Seq_all/05_lncrnaAnnotation_no_l_option/01_gffcompare/merged.annotated.gtf"))
merged_annotated <- import(file.path(datadir, "02_RNA-Seq_all/05_lncrnaAnnotation_no_l_option/feelnc_gencode_linc/01_gffcompare/merged.annotated.gtf"))
...
#export(novel, "/home/luisas/Desktop/cluster/data/01_Ebola-RNASeq_all/02_RNA-Seq_all/07_liftover/novel_rhemac10_after_gffcompare.gtf")
...
## Reference
# --------------------
dir_counts_ref = file.path(datadir, "02_RNA-Seq_all/06_counts_all")
