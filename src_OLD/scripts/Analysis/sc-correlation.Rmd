...
correlations<- lapply(all_genes, function(gene_id) calc_correlation_with_viralload(gene_id, infected_immune.combined_no_ebola, viral_load_percentage))
...
```{r Function Inference LncRNAs}
# Go enrichment 
p1 <- go_highest_lowest(all_genes, unlist(correlations), subset = "highest")
