...
inputgtf = Channel.fromPath("/gpfs/projects/bsc83/Data/gene_annotation/ensembl_release100/Macaca_mulatta.Mmul_10.100_copy.gtf").collect()
...
process feelnc_codpot{
  ...
  cpus 16
  storeDir "${params.output_dir}/00_feelNC_benchmark_macaque_fullinput/"
