...
params.dataset= "01_RNA-Seq_ribodepl"
...
params.lnc_novel_compared_to_ref= "${params.data_dir}/02_FEELnc_prediction/01_gffcompare/merged.annotated.gtf"
params.mrnas_predicted ="${params.data_dir}/02_FEELnc_prediction/feelnc_codpot_out/candidate_lncRNA.gtf.mRNA.gtf"
params.lnc_predicted ="${params.data_dir}/02_FEELnc_prediction/feelnc_codpot_out/candidate_lncRNA.gtf.lncRNA.gtf"
params.reference_annotated = "${params.prefix_data}/Ebola/01_bulk_RNA-Seq_lncRNAs_annotation/01_PreliminaryFiles_rheMac10/gene_annotations/rheMac10_EBOV-Kikwit.gtf"
...
// */
 process expression_stringtie{
   ...
   storeDir "${params.output_dir}/03_novel_lncRNAs_list/01_quantification_for_filtering/stringtie"
