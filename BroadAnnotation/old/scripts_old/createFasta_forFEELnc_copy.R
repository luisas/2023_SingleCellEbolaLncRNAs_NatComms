...
output_file_lncrna_human <-  file.path(prefix,'Ebola/01_bulk_RNA-Seq_lncRNAs_annotation/01_PreliminaryFiles_rheMac10/Homo_sapiens.GRCh38.100_known_lncrna_copy.fa')
output_file_mrna_human <-  file.path(prefix, 'Ebola/01_bulk_RNA-Seq_lncRNAs_annotation/01_PreliminaryFiles_rheMac10/Homo_sapiens.GRCh38.100_known_proteincoding_copy.fa')
