...
ref[substr(ref$gene_id, 1,3 ) == "MST" & ref$type == "exon",]$exon_id <- paste(ref[substr(ref$gene_id, 1,3 ) == "MST" & ref$type == "exon",]$transcript_id, ref[substr(ref$gene_id, 1,3 ) == "MST"  & ref$type == "exon",]$exon_number, sep = ".")
...
table(is.na(ref$exon_id))
table(substr(ref$gene_id, 1,3 ))
...
names(intersection_table_biotype) <- c("chrA", "startA", "endA", "complete_idA", "biotype", "strandA", "chrB", "startB", "endB", "complete_idB", "scoreB", "strandB", "overlap")
...
full_correspondence_reduced_filter <- full_correspondence_reduced[full_correspondence_reduced$perc_gene_orth_exons > 30, ]
novel_orth_macaque <- full_correspondence_reduced[substr(full_correspondence_reduced$macaque_gene, 1,3 ) == "MST",]

table(substr(full_correspondence_reduced_filter$macaque_gene, 1,3 ))

table(full_correspondence_reduced$perc_gene_orth_exons > 50 ) 

# Orthologs for how many of my lnc do i find? 
novel_orth_macaque <- full_correspondence_reduced_filter[substr(full_correspondence_reduced_filter$macaque_gene, 1,3 ) == "MST",]
annot_orth_macaque <- full_correspondence_reduced_filter[substr(full_correspondence_reduced_filter$macaque_gene, 1,3 ) != "MST",]
