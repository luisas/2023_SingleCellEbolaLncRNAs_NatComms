...
# Plot with correct
DimPlot(immune.combined, reduction = "umap", label = TRUE, cols =pal_celltypes, label.size = 9)+theme_minimal()+ theme(panel.background = element_rect(fill = "white", colour = "grey50"), panel.grid.major = element_blank(), panel.grid.minor = element_blank())+theme(legend.text = element_text(size=18))+theme(text = element_text(size=18))+theme_sc
```
# -------------------------------------
...
# Day post infection 
DimPlot(immune.combined, reduction = "umap", group.by = "group_dpi", pt.size = 0.1, cols = (brewer.pal(9, "Set3")))+theme_sc
