...
venn.diagram(
  ...
  filename = '/home/luisas/Desktop/cluster/data/mrna_venn_diagram_stagessignature_de_mrna_matched',
  output = TRUE ,
          imagetype="png" ,
          height = 680 , 
          width = 680 , 
...
venn.diagram(
  ...
  filename = '/home/luisas/Desktop/cluster/data/mrna_venn_diagramm_celltype_mrna_matched_new',
 output = TRUE ,
          imagetype="png" ,
          height = 580 , 
          width = 580 , 
...
ref_14 <- ref[seqnames(ref) == 14,]
seqnames(ref_14)
atrack <- AnnotationTrack(ref_14, name = "ref")
...
plotTracks(list(itrack, itrack,  gtrack, atrack), showId = TRUE, from = from , to = to, col = NULL, 
           background.title = "white", col.title = "black", cex.title = 1, lncRNA = palette_plot_percentage[1], protein_coding = palette_plot_percentage[2], cex.id = 2, sizes = c(2, 0.3,0.3,1))
