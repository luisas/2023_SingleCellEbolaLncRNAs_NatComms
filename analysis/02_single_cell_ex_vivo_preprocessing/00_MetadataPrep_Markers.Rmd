...
#cDCs <-  c("FLT3", "IRF8")
#pDCs <- c("IRF8","GZMB")
#Neutrophils <-  c("CD177", "LCN2")
#Platelets <-  c("PF4", "CAVIN2")
#Plasmablasts  <- c("MZB1", "IGHM", "IGHA")
#MDCK <- c("COL5A2", "SLC20A1")
...
#   `3` = "B", `4` = "T", `5` = "T", `6` = "B", `7` = "Monocyte", `8` = "B", `9` = "T",
#    `10` = "B", `11` = "Monocyte", `12` = "Monocyte",`13` = "B", `14` = "Monocyte", `15` = "Monocyte" )
