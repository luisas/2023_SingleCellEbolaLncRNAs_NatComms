...
ref <- import(file.path("/home/luisas/Desktop/cluster/data/01_bulk_RNA-Seq_lncRNAs_annotation/03_novel_lncRNAs_list/"))
...
data_dir <- "/home/luisas/Desktop/cluster/data/02_scRNA-Seq_PBMCs/00_scRNA-Seq_exVivo_rhemac10/04_DigitalExpressionMatrix"
...
pbmc <- readRDS(file.path(result_path,"EXVIVO_rhemac10_aftercellandgeneQC.rds"))
...
saveRDS(immune.combined, file.path(result_path, "EXVIVO_rhemac10_aftercellandgeneQC_afterScrublet_dimred.rds"))
