...
assembly_stranded <- import("/home/luisas/Desktop/cluster/data/99_BroadAnnotation_rerunningassemly/01_stringtie_assembly_merged/stringtie_merged_reference_guided.gtf")
...
lnc_novel_compared_to_ref_stranded <- import("/home/luisas/Desktop/cluster/data/99_BroadAnnotation_rerunningassemly/01_stringtie_assembly_merged/01_gffCompare/merged.annotated.gtf")
...
ggplot(df_classes_plot_summarized, aes(x = stranded, y = n, fill = classcode))+geom_bar(stat="identity", color="black", position=position_dodge())+
      theme_paper+
...
cpc2 <- read.table("/home/luisas/Desktop/cluster/data/99_BroadAnnotation_rerunningassemly/03_novel_lncRNAs_list/03_predictions/CPC2/cpc2_pred.txt")
...
cpat <- read.table("/home/luisas/Desktop/cluster/data/99_BroadAnnotation_rerunningassemly//03_novel_lncRNAs_list/03_predictions/CPAT/cpat_pred.ORF_prob.tsv", header = TRUE)
...
# -------------------------------------------
# Compare which ones and how many overlap 
cnit <- read.table("/home/luisas/Desktop/cluster/data/99_BroadAnnotation_rerunningassemly//03_novel_lncRNAs_list/03_predictions/CNIT/cnit_pred/CNCI2.index", header = TRUE, ,sep="\t")
