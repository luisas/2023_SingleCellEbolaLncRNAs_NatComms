...
# Only keep maximum score of alignment per ortholog
...
# Only keep maximum score of alignment per gene
...
orthologs_max_gene <- orthologs_max_gene %>% dplyr::left_join(orthologs_red, by = c("key_gene"))
