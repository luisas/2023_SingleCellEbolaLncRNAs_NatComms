...
hist(cpat_concordant$Coding_prob)
...
length(noncoding_cpc2_concordant)
length(coding_cpc2_concordant)
cpat_concordant_stats <- calc_stats_prediction(noncoding_cpat_concordant, coding_cpat_concordant, "cpat_concordant")
length(noncoding_cpat_concordant)
length(coding_cpat_concordant)
...
# Upset Plot
listInput <- list(cpat_concordant = unique(noncoding_cpat_concordant[noncoding_cpat_concordant %in% annotated_lnc]), cpc2_concordant = unique(noncoding_cpc2_concordant[noncoding_cpc2_concordant %in% annotated_lnc]), cnit_concordant = unique(noncoding_cnit_concordant[noncoding_cnit_concordant %in% annotated_lnc]),  annotated = annotated_lnc )

listInput <- list(cpat_concordant = unique(noncoding_cpat_concordant), cpc2_concordant = unique(noncoding_cpc2_concordant), cnit_concordant = unique(noncoding_cnit_concordant),  annotated = annotated_lnc )
