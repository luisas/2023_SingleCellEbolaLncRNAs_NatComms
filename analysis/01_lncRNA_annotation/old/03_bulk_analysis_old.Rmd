...
mds <- plotMDS(cpm(dge, log = TRUE,prior.count = 0.01), main=" samples on genes CPM", top=50,  gene.selection="common",col=, labels=dge$samples$condition)
dge$samples
...
mds <- plotMDS(cpm(dge, log = TRUE,prior.count = 0.01), top=200, col=col)
