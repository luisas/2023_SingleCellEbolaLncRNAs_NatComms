...
plot_seperate_features(immune.combined, gene  = c("ENSMMUG00000061948-unknown"), ident = "group")
plot_seperate_features(immune.combined, gene  = c("THY1"), ident = "group", colors =c('#DCD9DE','navy'))
```
...
de_lists_lnc <- list(lnc_Monocyte_late$primerid,lnc_Monocyte_middle$primerid, lnc_Monocyte_early$primerid,lnc_T_late$primerid, lnc_T_late$primerid, lnc_Monocyte_early$primerid, lnc_B_early$primerid, lnc_B_middle$primerid, lnc_B_late$primerid )
...
de_lists_mrna <- list(mrna_Monocyte_late$primerid,mrna_Monocyte_middle$primerid, mrna_Monocyte_early$primerid,mrna_T_late$primerid, mrna_T_late$primerid, mrna_Monocyte_early$primerid, mrna_B_early$primerid, mrna_B_middle$primerid, mrna_B_late$primerid )
