...
# 0. Default Color 
# 1. Up,down
V(gD2)$color <- ifelse(names(as.list(V(gD2))) %in% c(mono_de[mono_de$direction == "up", ]$id), "#DC3838", "#6989F5" )
...
# -------------------Plot the Graph 
png(filename = file.path(data_path,"plots/04/graph_SUPPL_stages2.png"), width = 3300, height = 2100)

png(filename = file.path("/home/luisasantus/Desktop/stages.png"), width = 3300, height = 2100)
