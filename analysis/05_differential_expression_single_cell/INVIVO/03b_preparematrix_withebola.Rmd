...
get_gene_id("ENSMMUT00000093663")
...
distances <- readRDS("/home/luisas/Desktop/cluster/data/02_scRNA-Seq_PBMCs/01_scRNA-Seq_inVivo_rhemac10/05_RObjects/05_stats/colocation_lnc_pc_de.rds")
...
de_myeloids_ebola <- myeloids[rownames(myeloids) %in% c(de_all$primerid,ebola_genes)]
de_b_ebola <- b[rownames(b) %in% c(de_all$primerid,ebola_genes)]
de_t_ebola <- t[rownames(t) %in% c(de_all$primerid,ebola_genes),]
