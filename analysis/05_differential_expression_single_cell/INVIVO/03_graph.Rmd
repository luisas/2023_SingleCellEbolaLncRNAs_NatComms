...
# -------------------Plot the Graph 
png(filename = file.path(data_path,"plots/05/graph_main.png"), width = 3300, height = 2100)
plot(lou2, gD2,
    edge.arrow.size = .1,
    col=V(gD2)$color,
    layout=l,
...
```
# ---------------------------------------------------------------------
#    Plot graph for supplementary: Dyrectionality of dyregulation 
# ----------------------------------------------------------------------
...
png(filename = file.path(data_path,"plots/05/SUPPL_graph_directionalityDysregulation.png"), width = 3300, height = 2100)
plot(lou2, gD2,
    edge.arrow.size = .1,
    col=V(gD2)$color,
    layout=l,
...
```
# ---------------------------------------------------------------------
#    Plot graph for supplementary: Stage of dyregulation 
# ----------------------------------------------------------------------
...
mono_de <- mono_de %>% group_by(id, type) %>% dplyr::summarise(stage = toString((stage)))
...
png(filename = file.path(data_path,"plots/05/SUPPL_graph_stage.png"), width = 3300, height = 2100)
plot(lou2, gD2,
    edge.arrow.size = .1,
    col=V(gD2)$color,
    layout=l,
...
dev.off()
```
# Store information about community 
