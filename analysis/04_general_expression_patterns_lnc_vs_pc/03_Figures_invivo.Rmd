...
# Save plot 
pdf(file.path(plots, "02/density_cells.pdf"), width = 6, height = 6)
density_cells
dev.off()
...
# Save plot 
pdf(file.path(plots, "02/density_medianexpression.pdf"), width = 6, height = 6)
density_cells
dev.off()
