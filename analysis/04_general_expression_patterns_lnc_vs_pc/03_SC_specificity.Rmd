...
pdf(file.path(plots, "02/SUPPL_spec_matching_cells_tau.pdf"), width = 6, height = 6)
match_plots(get_df_summary(tau), title  = "repurposed tau score")[[1]]
dev.off()

pdf(file.path(plots, "02/SUPPL_sepc_matching_score_tau.pdf"), width = 6, height = 6)
...
pdf(file.path(plots, "02/SUPPL_spec_tau_boxplotmarkers.pdf"), width = 3, height = 4)
stats_tau[[1]]
dev.off()
...
pdf(file.path(plots, "02/SUPPL_spec_alt_boxplotmarkers.pdf"), width = 3, height = 4)
alt_stats[[1]]
dev.off()

plots_ups <- match_plots(get_df_summary(specificity_scores), title = "upsilon")

pdf(file.path(plots, "02/SUPPL_spec_matching_cells_alt.pdf"), width = 6, height = 6)
plots_ups[[1]]
dev.off()

pdf(file.path(plots, "02/SUPPL_sepc_matching_score_alt.pdf"), width = 6, height = 6)
plots_ups[[2]]
dev.off()
...
pdf(file.path(plots, "02/MAIN_2I.pdf"), width = 4, height = 6)
plots_ups[[5]]
dev.off()
```
