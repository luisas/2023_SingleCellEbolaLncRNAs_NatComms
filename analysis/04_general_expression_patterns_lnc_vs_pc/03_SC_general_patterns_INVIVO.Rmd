...
immune.combined_lnc <- FindClusters(immune.combined_lnc, resolution = 0.5)

DimPlot(immune.combined_lnc, reduction = "umap", group.by = "batch")
DimPlot(immune.combined_lnc, reduction = "umap", label = TRUE)
