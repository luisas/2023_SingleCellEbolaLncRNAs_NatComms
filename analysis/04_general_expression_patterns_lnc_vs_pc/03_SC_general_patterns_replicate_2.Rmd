...
robjectsdir <- "/home/luisas/Desktop/cluster/data/02_scRNA-Seq_PBMCs/03_validation_pbmcs_external/05_stats"
...
file <- "/home/luisas/Desktop/cluster/data/02_scRNA-Seq_PBMCs/03_validation_pbmcs_external/v2_ut.rds"
immune.combined <- readRDS(file)
dim(immune.combined)

annotated_lncrnas <- rownames(immune.combined)[rownames(immune.combined) %in% lnc]
saveRDS(annotated_lncrnas,file.path(robjectsdir, "all_lncrnas.rds") )
