...
# Human training set
lncRNAs_ref_human <- import(file.path(datadir, "01_PreliminaryFiles_rheMac8/gene_annotations/gencode.v26.GRCh38.annotation_knownlncRNAs.gtf"))
...
lncRNAs_ref <- import(file.path(datadir, "01_PreliminaryFiles_rheMac8/gene_annotations/rheMac8_EBOV-Kikwit_lncrna.gtf"))
mRNAs_ref <- import(file.path(datadir, "01_PreliminaryFiles_rheMac8/gene_annotations/rheMac8_EBOV-Kikwit_mrnas.gtf"))


# Candidates lncRNAs 
candidates_lncRNA <- import(file.path(projdir, "02_RNA-Seq/05_lncrnaAnnotation/feelnc_gencode_linc/candidate_lncRNA.gtf"))

# Prediction 
lncRNAs_out <- import(file.path(projdir, "02_RNA-Seq/05_lncrnaAnnotation/feelnc_gencode_linc/feelnc_codpot_out/candidate_lncRNA.gtf.lncRNA.gtf"))
mRNAs_out <- import(file.path(projdir, "02_RNA-Seq/05_lncrnaAnnotation/feelnc_gencode_linc/feelnc_codpot_out/candidate_lncRNA.gtf.mRNA.gtf"))
