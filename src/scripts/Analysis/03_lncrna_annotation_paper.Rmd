...
merged_annotated <- import(file.path(datadir, "02_RNA-Seq_rheMac10/05_lncrnaAnnotation_no_l_option/feelnc_gencode_linc/01_gffcompare/merged.annotated.gtf"))
...
#export(novel, "/home/luisas/Desktop/cluster/data/01_Ebola-RNASeq/02_RNA-Seq_rheMac10/07_liftover/novel_rhemac10_after_gffcompare.gtf")
...
## Reference
# --------------------
dir_counts_ref = file.path(datadir, "02_RNA-Seq_rheMac10/06_counts_all")
...
export(novel_expressed, file.path(datadir,"/02_RNA-Seq_rheMac10/07_liftover/novel_rhemac10_expressed_all.gtf"))
...
#export(novel_intronic, file.path(datadir,"/02_RNA-Seq_rheMac10/07_liftover/novel_rhemac10_expressed_intronic.gtf"))
export(novel_antisense, file.path(datadir,"/02_RNA-Seq_rheMac10/07_liftover/novel_rhemac10_expressed_antisense.gtf"))
export(novel_intergenic, file.path(datadir,"/02_RNA-Seq_rheMac10/07_liftover/novel_rhemac10_expressed_intergenic.gtf"))
...
human_orthologs_all <- import("/home/luisas/Desktop/cluster/data/01_Ebola-RNASeq/02_RNA-Seq_rheMac10/07_liftover/human_novel_expressed.gtf")
#human_orthologs_intronic <- import("/home/luisas/Desktop/cluster/data/01_Ebola-RNASeq/02_RNA-Seq_rheMac10/07_liftover/human_novel_filtered_outliers_intronic.gtf")
human_orthologs_antisense <- import("/home/luisas/Desktop/cluster/data/01_Ebola-RNASeq/02_RNA-Seq_rheMac10/07_liftover/human_novel_expressed_antisense.gtf")
human_orthologs_intergenic <- import("/home/luisas/Desktop/cluster/data/01_Ebola-RNASeq/02_RNA-Seq_rheMac10/07_liftover/human_novel_expressed_intergenic.gtf")
